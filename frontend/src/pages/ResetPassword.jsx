    ...
    <div className="flex items-center justify-center min-h-screen bg-[#6c615c] p-4 font-sans">
      ...
      <div className="relative flex items-center w-4xl h-[45rem]">
        ...
        <div className="w-full h-full flex justify-center flex-col bg-white rounded-l-2xl shadow-lg z-10 p-10 sm:p-14">
          ...
          <h1 className="text-3xl sm:text-4xl font-extrabold text-[#483121] text-center leading-tight mb-12 w-2xs mx-auto">
          ...
          <form className="space-y-5">
            ...
            <div className="pt-4 flex justify-center">
              <button
                type="submit"
                className="w-1/2 px-6 py-4 bg-[#483121] text-white font-bold text-lg rounded-full hover:bg-[#664731] transition-colors duration-300 shadow-md cursor-pointer" 
              >
                Recuperar
              </button>
            </div>
        ...
        <div className="hidden md:block absolute top-0 bottom-0 right-[-100px] w-[60px] bg-[#483121] rounded-r-2xl"></div>
